journeyAppDirectives.directive('contentItem', function($compile){
		...
		var imageTemplate = '<div class="entry-photo"><h2>&nbsp;</h2><div class="entry-img"><span><img ng-src="{{rootDirectory}}{{post.photo}}" alt="entry photo"></a></span></div><div class="entry-text"><div class="entry-title">{{post.caption}}</div></div></div>';
	  ...
	  var textTemplate = '<div class="entry-note"><h2>&nbsp;</h2><div class="entry-text"><div class="entry-title">{{content.title}}</div><div class="entry-copy">{{content.data}}</div></div></div>';
